...
//Class copied from https://gist.github.com/Roland09/6fb31781a64d9cb62179
...
public class TableUtil {
	...
	public static void copySelectionToClipboard(TableView<?> table) {
		...
		for (TablePosition position : positionList) {
	    	...
	    	else if(observableValue instanceof ListProperty) {
	    		Object[] objectArray = ((ListProperty<String>) observableValue).toArray();
